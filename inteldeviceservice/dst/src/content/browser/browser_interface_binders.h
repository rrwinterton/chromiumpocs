...
// Allows tests to override how frame hosts binds DeviceServiceProvider
// receivers.
using DeviceServiceProviderBinder = base::RepeatingCallback<void(
    mojo::PendingReceiver<device::mojom::DeviceServiceProvider>)>;
CONTENT_EXPORT void OverrideDeviceServiceProviderBinderForTesting(
