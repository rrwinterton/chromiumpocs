...
CONTENT_EXPORT BASE_DECLARE_FEATURE(kDeviceService);
CONTENT_EXPORT BASE_DECLARE_FEATURE(kHardwareProfiling);
CONTENT_EXPORT BASE_DECLARE_FEATURE(kPanelRefreshRate);
