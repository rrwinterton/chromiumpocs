...
#include "services/device/public/mojom/device_service_provider.mojom-blink-forward.h"
...
class CORE_EXPORT MediaValues : public GarbageCollected<MediaValues>,
 ...
 public:
  ...
  virtual device::mojom::blink::DeviceServiceType GetDeviceService() const = 0;
 ...
 protected:
  ...
  static device::mojom::blink::DevicePostureType CalculateDevicePosture(
      LocalFrame*);
  static device::mojom::blink::DeviceServiceType CalculateDeviceService(
      LocalFrame*);
