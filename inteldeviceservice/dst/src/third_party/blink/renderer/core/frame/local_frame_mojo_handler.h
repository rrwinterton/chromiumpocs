...
class LocalFrameMojoHandler
 ...
 public:
  ...
  device::mojom::blink::DeviceServiceType GetDeviceService();
 ...
 private:
  ...
  void OnServiceChanged(device::mojom::blink::DeviceServiceType service) final;
  ...
  HeapMojoRemote<device::mojom::blink::DeviceServiceProvider>
      device_service_provider_service_{nullptr};
